...
- (UISearchBar *)searchBar {
    if (!_searchBar) {
        ...
        [_searchBar setSearchFieldBackgroundImage:[UIImage imageWithColor:[UIColor cyanColor] size:_searchBar.size] forState:UIControlStateNormal];
