...
- (void)popupViewFromSourceFrame:(CGRect)frame completion:(void (^ __nullable)(void))completion {
    ...
    [UIView animateWithDuration:AnimationDuration animations:^{
        ...
        self.bottomView.backgroundColor = [UIColor colorWithHexString:@"FCFAFD" alpha:1];
        ...
        for (int i = 0; i < 2 ; i++) {
            ...
            UIColor *titleColor = ((i == 0)?[UIColor blackColor]:[UIColor colorWithHexString:titleSelectedColor alpha:1]);
