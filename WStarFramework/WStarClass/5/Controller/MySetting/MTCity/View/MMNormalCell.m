...
- (void)layoutSubviews {
    ...
    self.title.frame = CGRectMake(self.selectedImageview.x + 20, 0, 100, self.height);
...
- (void)setItem:(MMItem *)item{
    ...
    self.title.textColor = item.isSelected?[UIColor colorWithHexString:titleSelectedColor alpha:1]:[UIColor blackColor];
