...
- (void)setItem:(MMItem *)item {
    ...
    for (int i = 0; i < item.childrenNodes.count; i ++) {
        ...
        button.layer.borderWidth = 1.0/Kscale;
        button.tag = i;
        button.layer.borderColor = [UIColor colorWithHexString:@"e8e8e8" alpha:1].CGColor;
        ...
        button.backgroundColor = subItem.isSelected?[UIColor colorWithHexString:titleSelectedColor alpha:1]:[UIColor whiteColor];
